...
<body class="sidebar-mini layout-fixed layout-navbar-fixed hold-transition overflow-x-hidden">
    ...
    ?>
        ...
        <div class="content-wrapper d-flex align-items-center">
            <div class="container shadow chat d-flex flex-column justify-content-center p-0">
                <div class="card direct-chat m-0 p-0">
                    <div class="card-header chat-theme">
                    ...
                    <div class="card-body">
                        ...
                        <div class="direct-chat-messages">
                            ...
                            <div class="direct-chat-msg right">
                                ...
                                <!-- /.direct-chat-infos -->
                                <div class="direct-chat-text chat-theme me-2">
                                    Hi!
                                </div>
                                <!-- /.direct-chat-text -->
                            </div>
                    ...
                    <form action="#" method="post">
                        <div class="input-group">
                            ...
                            <span class="input-group-append">
                                <button type="button" class="btn chat-theme">Send</button>
                            </span>
                        </div>
                    </form>
                </div>
