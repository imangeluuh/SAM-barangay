<?php
    ...
    $lang['concernType'] = array(
        "neighbor" => "Disruptive Neighbor"
        , "abusive_employee" => "Abusive Barangay Employee"
        , "loud_videoke" => "Loud Videoke"
        , "doesnt_follow" => "Doesn't Follow The Principle Of 'Tapat Ko, Linis Ko'"
        , "thief" => "Thief"
